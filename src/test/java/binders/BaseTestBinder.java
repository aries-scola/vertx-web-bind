...
public abstract class BaseTestBinder extends WebTestBase {

	private void assertResult(Object result, Object[] expectedResults) {
		if (result==null) {
			assertTrue(expectedResults==null || expectedResults.length==0);
		}
			...
			if (result instanceof Collection) {
				...
				assertTrue(expectedResults.length == collection.size());
				Iterator<?> it = collection.iterator();
				for (Object expectedResult: expectedResults) {
					assertTrue(expectedResult.equals(it.next()));
				}
			}
